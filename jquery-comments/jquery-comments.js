    ...
    var Comments = {
        ...
        postComment: function(ev) {
            ...
            var success = function(commentJSON) {
                ...
                commentingField.find('.close').trigger('click', 'post');
            };
        ...
        toggleMainCommentingField: function(visible) {
            visible ? this.mainCommentingField.show() : this.mainCommentingField.hide();
            if (visible) {
                $('.commenting-field.main .textarea').click();
            }
        },
        ...
        createHTML: function() {
            ...
            this.mainCommentingField = mainCommentingField;
